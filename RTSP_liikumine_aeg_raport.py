...
try:
    ...
    if first_60s_timing_stats:
        ...
        print(f"  Average: {first_60s_timing_stats['mean_ms']:.3f} ms")
        print(f"  Median:  {first_60s_timing_stats['median_ms']:.3f} ms")
        print(f"  P95:     {first_60s_timing_stats['p95_ms']:.3f} ms")
        print(f"  Min:     {first_60s_timing_stats['min_ms']:.3f} ms")
        print(f"  Max:     {first_60s_timing_stats['max_ms']:.3f} ms")
        print(f"  Theoretical FPS from average: {first_60s_timing_stats['theoretical_fps_from_mean']:.2f}")
